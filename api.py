...
#     # Build Whoosh index for BM25 if it doesn't exist
#     if not os.path.exists(os.path.join("data", "whoosh_index")):
#         print("Building Whoosh index for hybrid reranker...")
#         build_whoosh_index(app.state.chunks_data)
...
#     top_score = contexts[0]['scores'].get('final', 0)
    
#     # Also consider if the top chunk is just a generic document opening
...
#     retrieved_contexts = vector_search(request.q, k=request.k)
